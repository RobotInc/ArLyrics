...
public class songList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        songref.child("AR Rahman").child("Tamil").child(getActivity().getIntent().getExtras().getString("Title")).addValueEventListener(new ValueEventListener() {
            @Override
